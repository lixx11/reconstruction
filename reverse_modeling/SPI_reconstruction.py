...
if __name__ == '__main__':
    ...
    if show_gui == 'True':
        ...
        win.nextRow()
        p2 = win.addPlot(title='<p><font size="4">Searched Costs</font></p>', colspan=5)
        curve2 = p2.plot()
        line2 = p2.plot(pen=pg.mkPen('r'))
        scatter2 = pg.ScatterPlotItem()
        p2.addItem(scatter2)
        win.nextRow()
        p3 = win.addPlot(title='<p><font size="4">Accepted Costs</font></p>', colspan=5)
        curve3 = p3.plot()
        line3 = p3.plot(pen=pg.mkPen('r'))
        scatter3 = pg.ScatterPlotItem()
        p3.addItem(scatter3)
        win.nextRow()
        p4 = win.addPlot(title='<p><font size="4">Temperature</font></p>', colspan=5)
